    ...
    <footer class="bg-[#002642] dark:bg-gray-900 text-white pt-12 pb-8 px-6 transition-colors duration-300">
        ...
        <div class="mt-10 border-t border-gray-700 pt-6 text-center text-sm text-gray-400 dark:text-gray-500">
            <div class="flex justify-center gap-6 mb-4">
                <a href="#" class="hover:text-white dark:hover:text-green-300" aria-label="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-green-300" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="#" class="hover:text-white dark:hover:text-green-300" aria-label="Twitter">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-green-300" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="#" class="hover:text-white dark:hover:text-green-300" aria-label="Instagram">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-green-300" viewBox="0 0 24 24" fill="currentColor">
